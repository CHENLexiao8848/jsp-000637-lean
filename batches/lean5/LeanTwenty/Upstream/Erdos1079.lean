...
/- Ported to Lean/mathlib v4.34.0 for this workspace on 2026-09-17.
Source commit: plby/lean-proofs@8822f7ddef30fadbd92e1c6ab4ed897af356af5e.
Modification: use the v4.34 Turan-number recurrence after rewriting graph edge counts.
Apache-2.0 text is provided in licenses/Apache-2.0.txt. -/
/- Original license: Apache 2.0. Note: This file has been modified. -/
/-
This is a Lean formalization of a solution to Erdős Problem 1079.
https://www.erdosproblems.com/forum/thread/1079
...
URLs:
- https://github.com/plby/lean-proofs/blob/main/ErdosProblems/Erdos1079.md
-/
/-
...
lemma sq_le_four_mul_card_turanGraph_two_add_one (n : ℕ) :
  ...
  | more n ih₀ _ih₁ =>
      change n ^ 2 ≤ 4 * SimpleGraph.turanNumber n 2 + 1 at ih₀
      change (n + 2) ^ 2 ≤ 4 * SimpleGraph.turanNumber (n + 2) 2 + 1
      rw [SimpleGraph.turanNumber_add (n := n) (r := 2)]
