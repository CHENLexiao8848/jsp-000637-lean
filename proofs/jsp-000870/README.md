...
The infinite real series sum_{n>=1} 1/(2^n-3) is irrational. The proof establishes summability and constructs nonzero integer linear forms tending to zero; it is not merely a finite numerical check.
...
Only import Mathlib replaced by Polynomial.Roots, SpecificLimits.Normed and Tactic; proof text and theorem unchanged.
...
Entrypoint: [JSP000870.lean](JSP000870.lean). Declarations: Formalization20.jsp_000870.
